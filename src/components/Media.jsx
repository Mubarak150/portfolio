...
export default function Media () {
    return (
        <div className="media contents">
                    <a href='https://www.linkedin.com/in/muhammad-mubarak-b57791249' className="flex gap-2 p-3 justify-center items-center group">
                    ...
                    <a href='https://www.github.com/Mubarak150/' className="flex gap-2  p-3 justify-center items-center group">
                        ...
                        <p className="opacity-0 hidden group-hover:opacity-100 group-hover:inline">Git Hub</p>
                    </a>
